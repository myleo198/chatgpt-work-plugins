...
This skills-only bundle packages or adapts the following open-source skill materials. It does not bundle external API credentials, Aki server runtime files, generated model assets, caches, or user data.
...
Copies of the applicable licenses are in `LICENSES/`. Upstream names and marks remain the property of their respective owners.
